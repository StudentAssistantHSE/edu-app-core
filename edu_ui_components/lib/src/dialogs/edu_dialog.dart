import 'package:edu_ui_components/src/dialogs/check_list_dialog_content.dart';
import 'package:edu_ui_components/src/dialogs/edu_dialog_action.dart';
import 'package:edu_ui_components/src/dialogs/information_list_dialog_content.dart';
...
class EduDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AlertDialog(
    title: title == null ? null : Text(title?.toUpperCase() ?? '', textAlign: TextAlign.center),
    content: content,
    ...
    actions: actions
        ?.map((e) => PrimaryButton(
              ...
              style: e.style.asPrimaryButtonStyle,

...
class CustomPinCodeTextField extends StatefulWidget {
  ...
  /// If the pin code field should be autofocused or not
  ...
  /// Enabled Color fill for individual pin fields
  final bool enableActiveFill;

  /// Auto dismiss the keyboard upon inputting the value for the last field
  final bool autoDismissKeyboard;

  /// Auto dispose the [controller] and [FocusNode] upon the destruction of widget from the widget tree

...
class CheckListDialogItem {
  final String text;
  final bool? isCompleted;

  const CheckListDialogItem(this.text, { this.isCompleted });
}

class CheckListDialogContent extends StatelessWidget {
  final List<CheckListDialogItem> items;
...
class _PrefixIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Icon(
      ...
      size: 16.0,
      color: value ? EduPalette.green600 : theme.colorScheme.error,
    );
  }
}